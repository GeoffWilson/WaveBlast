...
//            graphicsDevice.setDisplayMode(new DisplayMode(this.resolutionX, this.resolutionY, colorDepth, DisplayMode.REFRESH_RATE_UNKNOWN));
        ...
        try {
            ...
            prop.load(GameEngine.class.getResourceAsStream("/config.prop"));
            highScore = Integer.parseInt(prop.getProperty("highscore"));

            flashTimer = new Timer();
            flashTimer.schedule(new FlashTimer(), 0, 500);
            title = ImageIO.read(GameEngine.class.getResourceAsStream("/sprites/title.png"));
            uiPower = ImageIO.read(GameEngine.class.getResourceAsStream("/sprites/powerup-1.png"));
            uiShield = ImageIO.read(GameEngine.class.getResourceAsStream("/sprites/ship-shield-5.png"));
            uiLife = ImageIO.read(GameEngine.class.getResourceAsStream("/sprites/ship.png"));
